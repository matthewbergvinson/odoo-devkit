...
class ExampleController(http.Controller):
    ...
    def create_example(self, **kwargs):
        ...
        try:
            ...
            return {'success': True, 'id': example.id, 'message': 'Example created successfully'}
    ...
    def example_action(self, example_id, action, **kwargs):
        ...
        try:
            ...
            return {'success': True, 'state': example.state, 'message': f'Action {action} completed successfully'}
        except Exception as e:
            return {'success': False, 'error': str(e)}
