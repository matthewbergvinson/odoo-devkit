...
class TestExampleModel(BaseModelTest):
    ...
    def test_example_model_relationships(self):
        ...
        example = self.Example.create({
            'name': 'Relationship Test Example',
            'value': 100.0,
    ...
    def test_example_model_search_filtering(self):
        ...
        # Create test records
        example1 = self.Example.create({
            'name': 'Example Alpha',
            'value': 100.0,
            'state': 'draft'
        })
        
        example2 = self.Example.create({
            'name': 'Example Beta',
            'value': 200.0,
            'state': 'confirmed'
        })
        
        example3 = self.Example.create({
            'name': 'Example Gamma',
            'value': 150.0,
            'state': 'done'
        })
        ...
        # Test ordering
        ordered_results = self.Example.search([
            ('name', 'in', ['Example Alpha', 'Example Beta', 'Example Gamma'])
        ])
...
class TestExampleLine(BaseModelTest):
    ...
    def setUp(self):
        ...
        self.example = self.Example.create({
            'name': 'Parent Example',
            'value': 100.0
        })
